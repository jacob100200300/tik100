...
<option value="<?= $category["category_id"] ?>" <?php if ($category["category_id"] == $categoryId) : ?>selected="selected" <?php endif; ?>><?= $category["category_name"] ?>
</option>
        <?php endforeach; ?>
    </select>
</td>
...
if (name.toUpperCase().indexOf(filter) > -1) {
 ...
 <script src="public/dilip/api_services/main.js"></script>