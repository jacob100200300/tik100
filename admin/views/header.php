...
<link rel="stylesheet" href="https://use.fontawesome.com/releases/v5.13.0/css/all.css">
    ...
    <link rel="stylesheet" type="text/css" href="//cdn.smmpanelbdlab.com/css/SMMSUNBD/admin/public/dilip/header/bootstrap.css">
    <link rel="stylesheet" type="text/css" href="//cdn.smmpanelbdlab.com/css/SMMSUNBD/admin/public/dilip/header/style.css">
    <link rel="stylesheet" type="text/css" href="//cdn.smmpanelbdlab.com/css/SMMSUNBD/admin/public/dilip/header/toastDemo.css">
	<link rel="stylesheet" type="text/css" href="//cdn.smmpanelbdlab.com/css/SMMSUNBD/admin/public/dilip/header/tooltip.css">
	
<link href="//cdn.smmpanelbdlab.com/css/SMMSUNBD/admin/cdnjs.cloudflare.com/summernote.min.css" rel="stylesheet">

    <link rel="stylesheet" type="text/css" href="//cdn.smmpanelbdlab.com/css/SMMSUNBD/admin/cdnjs.cloudflare.com/codemirror.css">
    <link rel="stylesheet" type="text/css" href="//cdn.smmpanelbdlab.com/css/SMMSUNBD/admin/cdnjs.cloudflare.com/monokai.css">


    <link rel="stylesheet" type="text/css" href="//cdn.smmpanelbdlab.com/css/SMMSUNBD/admin/public/dilip/header/tinytoggle.min.css" rel="stylesheet">
 <link rel="stylesheet" href="//cdn.smmpanelbdlab.com/css/SMMSUNBD/admin/public/admin/iziToast.min.css">
  <script src="https://kit.fontawesome.com/f9fbee3ddf.js" crossorigin="anonymous"></script>
<script src="//cdn.smmpanelbdlab.com/css/SMMSUNBD/admin/public/admin/iziToast.min.js"></script>
<script src="js/admin/apex.js"></script>
  <link href="//cdn.smmpanelbdlab.com/css/SMMSUNBD/admin/cdnjs.cloudflare.com/bootstrap-toggle.min.css" rel="stylesheet">

<link href="//cdn.smmpanelbdlab.com/css/SMMSUNBD/admin/cdnjs.cloudflare.com/bootstrap.min.css" type="text/css" rel="stylesheet">
<link rel="stylesheet" href="//cdn.smmpanelbdlab.com/css/SMMSUNBD/admin/cdnjs.cloudflare.com/bootstrap-select.css">
<link rel="stylesheet" href="https://itsjavi.com/fontawesome-iconpicker/dist/css/fontawesome-iconpicker.min.css">
<link rel="stylesheet" href="//cdn.smmpanelbdlab.com/css/SMMSUNBD/admin/cdnjs.cloudflare.com/image-picker.css">
	<link href="//cdn.smmpanelbdlab.com/css/SMMSUNBD/admin/cdnjs.cloudflare.com/main.css" type="text/css" rel="stylesheet">
    <style>
...
aria-haspopup="true" aria-expanded="false"><i class="fa fa-wrench" aria-hidden="true"></i>
Services<span class="caret"></span></a>

<ul class="dropdown-menu dropdown-max-height">

<li class="<?php if (route(1) == "services") : echo 'active' ; endif; ?>"><a
class="ajax-link" href="<?php echo site_url("admin/services") ?>"><i class="fa fa-wrench" aria-hidden="true"></i><span> Services</span></a></li>
...
href="<?php echo site_url("admin/settings") ?>"><i class="fa fa-cog" aria-hidden="true"></i>
