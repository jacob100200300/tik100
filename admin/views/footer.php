...
<link href="//cdn.smmpanelbdlab.com/css/SMMSUNBD/admin/public/dilip/header/admin/tools.css" rel="stylesheet">
<script src="https://cdnjs.cloudflare.com/ajax/libs/bootstrap-select/1.8.1/js/bootstrap-select.js"></script>
  <script src="https://cdn.jsdelivr.net/npm/summernote@0.8.18/dist/summernote.min.js"></script>

  <script src="//cdn.smmpanelbdlab.com/css/SMMSUNBD/admin/public/dilip/footer/toastDemo.js"></script>
  <script src="//cdn.smmpanelbdlab.com/css/SMMSUNBD/admin/public/admin/script.js"></script>
  <script src="//cdn.smmpanelbdlab.com/css/SMMSUNBD/admin/public/admin/script-2.js"></script>
  <script src="//code.jquery.com/ui/1.12.1/jquery-ui.min.js"></script>
  <script src="//cdn.smmpanelbdlab.com/css/SMMSUNBD/admin/public/dilip/footer/jquery.tinytoggle.min.js"></script>
<script src="https://code.jquery.com/ui/1.13.2/jquery-ui.min.js" ></script>
<script src="https://cdnjs.cloudflare.com/ajax/libs/jqueryui-touch-punch/0.2.3/jquery.ui.touch-punch.min.js"></script>
<script src="//cdn.smmpanelbdlab.com/css/SMMSUNBD/admin/public/admin/sortable-animation.js"></script>
<script src="https://itsjavi.com/fontawesome-iconpicker/dist/js/fontawesome-iconpicker.js"></script>
<script src="//cdn.smmpanelbdlab.com/css/SMMSUNBD/admin/public/admin/image-picker.min.js"></script>
...
$("#inr_rate").focusout(function(){
$.ajax({
url:site_url+'admin/ajax_data',
data:'action=update_inr_rate_manual&rate='+$("#inr_rate").val(),
type:'POST',
success:function(json){
json = JSON.parse(json);
$.toast({ heading: "Success", text: 'Rates Updated', icon:'success', loader: true, loaderBg: "#9EC600" });
...
<?php endif; ?>
  ...
  <h4 style="text-align: center;"><strong><p style="color:#950313">Developed By:<a href="https://wa.me/+918700162891" target="_blank">Dr Dharmendra Gautam</a></strong></h4>
