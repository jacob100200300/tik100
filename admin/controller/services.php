...
unset($_SESSION["admin_services_currency"]);
...
$multiDesc    = $_POST["description"];

            $conn->beginTransaction();
$update = $conn->prepare("UPDATE services SET service_description=:description WHERE service_id=:id ");
...
$conn->beginTransaction();
$update = $conn->prepare("UPDATE categories SET category_name=:name,category_icon=:icon WHERE category_id=:id");
$update = $update->execute(array(
"name"=>$name,
"icon" => $save,
"id"=>$category_id
