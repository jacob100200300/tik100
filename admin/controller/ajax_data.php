...
$services->execute(array("api" => $_POST["id"]));
...
<textarea class="form-control" rows="5"  name="description">'.rtrim(str_replace(["<br>","<br/>","<br />"],"\n",$multiDesc)).'</textarea>
</div>';
...
elseif ($action == "edit_admin") :
  ...
  " method="post" data-xhr="true">
            <div class="modal-body">
              ...
              <div class="form-group">
                <label>Email</label>
                <input type="text" name="email" value="' . $adminData["email"] . '" class="form-control">
              </div>
    
              <div class="form-group">
                <label>Username</label>
                <input type="text" name="username" class="form-control" readonly value="' . $adminData["username"] . '">
              </div>
              ...
              <label>Account Status</label>
                <select class="form-control" name="client_type">
                      <option value="1"';
  if ($adminData["client_type"] == 1) : $return .= 'selected';
  endif;
  $return .= '>Inactive</option>
                      <option value="2"';
  if ($adminData["client_type"] == 2) : $return .= 'selected';
  endif;
  $return .= '>Active</option>
                  </select>
              </div>
  ...
  foreach ($permission_array as $group => $array) :
    ...
    foreach ($array as $perm) :
      ...
      if ($access[$perm_value] == 1) :   $return .= ' selected ';
      endif;
